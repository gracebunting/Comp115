...
Your answer is: Yes because they both return the num == target, but will return -1 if no num == target. 
...
functionality? Why? (5 marks)
Your answer is: No because there is no return statement in the for loop, so it will return a different value than practice_for_index_3. 
...
Your answer is: It will print 5, then 5, then 9, then 6
...
assert good_neighbours("arrrhhh") == 4
assert good_neighbours("happy") == 1
